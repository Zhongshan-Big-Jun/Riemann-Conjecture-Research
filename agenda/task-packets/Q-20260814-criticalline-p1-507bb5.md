...
**Created**: 2026-08-14 · **Status**: READY (B0 preflight complete)
...
## 8. Novelty preflight (B0)

- **Openness verdict** (checked 2026-08-14): "N0/N → 1" OPEN; "N0^s/N ≥ 2/3" proved 2026-08
  (Anthropic); "N0^s/N ≥ 0.673008528" is an unverified 2026-08-13 draft (OpenAI). Any
  unconditional c > 0.673008528 (or verified proof of that constant) is novel.
- **Audit path**: divergent search + deep reads, logged in literature/maps/FRONTIER.md §1–§2.
- **Snapshot hash**: knowledge base empty (fresh init); no accepted-knowledge dependencies;
  binding snapshot = project git commit at dispatch (recorded in the run's repro_manifest).
- **Novelty risk line**: FRONTIER.md §3.
