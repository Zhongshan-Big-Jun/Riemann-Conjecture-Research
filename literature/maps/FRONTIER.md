...
| **0.6733169771424713… (EXTERNAL CANDIDATE, PLAUSIBLE-WITH-GAPS)** | **N0^s/N ≥ (219·H_cert − (1−u)213·6/2736 − u·211·8/2500)/(219−R), via two-certificate (7+9 point) supporting-plane trace-energy method; H_cert=3362285207/5000000000; local scripts PASS; Lean local layer partial (`hTrace` spectral split assumed); upstream certificates/interface pinned, not replayed** | **yuhangshi888/zeta-simple-zeros-673316977 v0.1.0 (Zenodo 10.5281/zenodo.21926962); audit R-20260817T020000Z-shiAudit-7c1e; reports/shi-673316977-analysis.md — NOT accepted as certified theorem** |
...
| **SL m₇/m₈ partial update 2026-08-16 (run R-20260816T110000Z-m7exact-ea0a, RIGOROUS_PARTIAL_RESULT)**: exact m₇ partial — k=7 G2 pruning 877→540 survivors→18 isoclasses; all 10 b≤3 isoclasses computed EXACTLY (m₇^(b≤3)=1345/72≈18.6806); 8 b=4 isoclasses remain open (heavy). k=8 preflight 4140→2683 survivors→46 isoclasses; full m₈ infeasible, exact b≤2 partial m₈^(b≤2)=3724369/181440≈20.5267. Λ₄(0) remains open until full m₇. | this project |
