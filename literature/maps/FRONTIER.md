...
| **0.6730536459526…** | **N0^s/N ≥ (6875·H_MT − 1315/96)/6849 — NEW RECORD via k=9 pressure certificate (F₈ ≥ 39/10000, 8-var Arb certificate, 53M nodes)** | **This project (extpress run R-20260814T045000Z-extpress-2f36ae, 2026-08-14); manager-level audit PASS with scope limits (full grid-4000 re-run pending); third-party re-audit recommended** |
...
| **0.86918353505… (CANDIDATE)** | ξ′ pressure method: (6875·H_{ξ′}^{MT} − 1315/96)/6849 — exceeds quartic 0.86864; full derivation + audits A1–A4 (A2 closed) | this project, reports/xi-prime-cor22-derivation.md (pending independent audit) |
