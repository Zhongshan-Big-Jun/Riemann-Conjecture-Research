...
| O5 | T3 ξ′ record: C₉(ξ′) = (657,500·H_{ξ′} − 1,310)/655,001, H_{ξ′} = 2 − κ₁(1,vMT) (AtOne certificate content) | 🔶 MACHINE-ACCEPTED_PENDING_AUDIT / REPAIRABLE_GAP (`kappaXi_one_vMT_mem`/`H_xip_vMT_mem` compile conditionally; AtOne analytic facts 4/5 promoted — `Record9.XiPrimeAtOneFacts` and `Record9.XiPrimeAtOneFacts2` build exit 0; last open hypothesis `jWin_D1_one_vMT_sandwich`) | lean-proof/Record9/Record9/{XiPrimeAtOne,XiPrimeAtOneFacts,XiPrimeAtOneFacts2}.lean |
