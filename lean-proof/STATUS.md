...
| O2 | General-k chain in ε-form (k=9, m=263, A₀ = 2499/2500): (1 − A₀/m)·N₀ˢ(T,2T) ≥ (H_MT − (m−1)/(500m) − ε)·N(T,2T) assuming certified F₈ ≥ 392/100000 | 🔶 MACHINE-ACCEPTED (T1 pass + REPAIR re-audit: `chain9_eps` compiles, `lake build Record9.Chain9` exit 0/8838 jobs, axioms gold standard; T1a/b/c/d FAITHFUL; wMT finding CLOSED; **T1c kernel-limit lemma CLOSED at machine level** (`Record9.KernelLimit`, lake build exit 0/8839 jobs); **T1c stability bridges machine-accepted** (`Record9.StabilityBridge`, lake build exit 0/8839 jobs; Ψ-defect + additive +Δ survival + averaged constants; spectral/pinching/uniformity sub-steps carried as honest hypotheses); open: T1c sub-step proofs, T2) | lean-proof/Record9/Record9/{Chain9,KernelLimit,StabilityBridge}.lean |
